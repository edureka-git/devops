...
RUN curl --output addressbook.war localhost:8182/artifactory/libs-release-local/com/edurekademo/tutorial/addressbook/$latest_success/addressbook-$latest_success.war
