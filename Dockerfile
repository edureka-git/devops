...
CMD apt-get -qq update & apt-get curl
CMD  curl --output $CATALINA_HOME/webapps/addressbook.war ${server_domain}:8081/artifactory/libs-release-local/com/edurekademo/tutorial/addressbook/${latest_success}/addressbook-${latest_success}.war
