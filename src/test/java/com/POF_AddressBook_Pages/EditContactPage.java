...
public class EditContactPage {
	...
	public  void editcontact(String firstname , String lastname, String phone, String email, String dob) throws InterruptedException {
		...
		System.out.println("I am in Editcontact Page############");
		//WebElement firtstnameget1 = driver.findElement(firtstnameget);
		WebElement editcontact= wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='v-grid-tablewrapper']/table/tbody/tr[@class='v-grid-row v-grid-row-stripe v-grid-row-has-data'][1]/td[@class='v-grid-cell'][1]")));
		System.out.println("Click on editcontact button.........");
		editcontact.click();
